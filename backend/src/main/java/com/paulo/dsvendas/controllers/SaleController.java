package com.paulo.dsvendas.controllers;
...
public class SaleController {
	...
	public ResponseEntity<List<SaleSuccsessDTO>> successGroupedBySeller(){
		List<SaleSuccsessDTO> list = service.succsessGroupedBySeller();
		return ResponseEntity.ok(list);
	}	
